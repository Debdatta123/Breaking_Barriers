		...
		<div class="container">
			<div class="site-breadcrumb">
				<div class="section-title" >
					...
					<p style="color: white;">These are some of the courses we offer<br>Select the course you wish to upload your content on</p>
				</div>  		
            </div>
        <div>
        </div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="categorie-item">
						...
						<div class="ci-text">
							<h5>Python</h5>
							<p></p><br>
							<a href="python_upload.php" class="site-btn">Upload content</a>	
						</div>
					</div>
				</div>
				<!-- categorie -->
				<div class="col-lg-4 col-md-6">
					<div class="categorie-item">
						...
						<div class="ci-text">
							<h5>Web Design</h5>
							<p></p><br>
							<a href="wed_upload.php" class="site-btn">Upload content</a>	
						</div>
					</div>
				</div>
				<!-- categorie -->
				<div class="col-lg-4 col-md-6">
					<div class="categorie-item">
						...
						<div class="ci-text">
							...
							<p></p><br>
							<a href="digitalmar_upload.php" class="site-btn">Upload content</a>
						</div>
					</div>
				</div>
				<!-- categorie -->
				<div class="col-lg-4 col-md-6">
					<div class="categorie-item">
						...
						<div class="ci-text">
							...
							<p></p><br>
							<a href="ml_upload.php" class="site-btn" >Upload content</a>	
							</div>
					</div>
				</div>
				<!-- categorie -->
				<div class="col-lg-4 col-md-6">
					<div class="categorie-item">
						...
						<div class="ci-text">
							<h5>Photoshop</h5>
							<p> </p><br>
							<a href="photo_upload.php" class="site-btn">Upload content</a>
						</div>
					</div>
				</div>
				<!-- categorie -->
				<div class="col-lg-4 col-md-6">
					<div class="categorie-item">
						...
						<div class="ci-text">
							...
							<p></p><br>
							<a href="sd_upload.php" class="site-btn">Upload content</a>
						</div>
					</div>
				</div>
			</div>
