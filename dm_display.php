...
<body>
	...
	<div class="page-info-section set-bg" data-setbg="img/page-bg/1.jpg">
        ...
        <div>
            ...
            <h5 style="color:white; text-align: center;">View Digital Marketing content here</h5>
        </div>       
...
$query = $db->query("SELECT * FROM digimark ORDER BY uploaded_on DESC");
